...
export function EntityDetails({}) {
    ...
    return (_jsxs(_Fragment, { children: [currentResource === 'people' && currentResourceDetails && (_jsx(People, { data: currentResourceDetails })), currentResource === 'planets' && currentResourceDetails && (_jsx(Planet, { data: currentResourceDetails })), currentResource === 'films' && currentResourceDetails && (_jsx(Film, { data: currentResourceDetails })), currentResource === 'species' && currentResourceDetails && (_jsx(Specie, { data: currentResourceDetails })), currentResource === 'vehicles' && currentResourceDetails && (_jsx(Vehicle, { data: currentResourceDetails }))] }));
}
